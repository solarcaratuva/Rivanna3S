...
SPI_HandleTypeDef* SPI_init(SPI_TypeDef *i2cHandle, uint32_t baudrate_prescaler) {
    if (i2cHandle == I2C1) {
        MX_I2C1_Init(baudrate_prescaler);
        return &hi2c1;
    }
    else if (i2cHandle == I2C2) {
        MX_I2C2_Init(baudrate_prescaler);
        return &hi2c2;
    }
    else if (i2cHandle == I2C3) {
        MX_I2C3_Init(baudrate_prescaler);
        return &hi2c3;
    }
    else if (i2cHandle == I2C4) {
        MX_I2C4_Init(baudrate_prescaler);
        return &hi2c4;
    }
    else if (i2cHandle == I2C5) {
        MX_I2C5_Init(baudrate_prescaler);
        return &hi2c5;
    }
    else if (i2cHandle == I2C6) {
        MX_I2C6_Init(baudrate_prescaler);
        return &hi2c6;
    }
    else {
