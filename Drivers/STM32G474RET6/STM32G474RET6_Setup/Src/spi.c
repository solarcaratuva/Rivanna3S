...
void MX_SPI1_Init(uint32_t baudrate_prescaler) // <-- This line changed when importing
{
  ...
  hspi1.Init.BaudRatePrescaler = spi_prescaler_from_baud(400, baudrate_prescaler); // <-- This line changed when importing
...
void MX_SPI2_Init(uint32_t baudrate_prescaler) // <-- This line changed when importing
{
  ...
  hspi2.Init.BaudRatePrescaler = spi_prescaler_from_baud(400, baudrate_prescaler); // <-- This line changed when importing
