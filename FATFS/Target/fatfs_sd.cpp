...
static bool SD_TxDataBlock(const uint8_t *buff, BYTE token)
{
    ...
    if (token != 0xFD)
    {
        ...
        // FIX 3: Fix infinite loop with no timeout
        // Add a timeout to prevent the system from hanging if the card remains busy (0x00) indefinitely.
        Timer1 = 200; // 200ms timeout
...
DRESULT SD_disk_ioctl(BYTE drv, BYTE ctrl, void *buff)
{
    ...
    else
    {
        ...
        case MMC_GET_OCR:
            ...
            // FIX 4: Add missing break
            // The absence of a break here caused the flow to fall through to the default case,
            // which would overwrite the res value with RES_PARERR. This fixes that issue.
            break;
        default:
            res = RES_PARERR;
        }
