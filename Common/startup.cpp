...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  xTaskCreate(app_main, "app_main", 512, NULL, tskIDLE_PRIORITY + 1, NULL);
  vTaskStartScheduler();
  /* USER CODE END 2 */
...
#else
  #error "SystemClock_Config not implemented for this MCU."
#endif
}
...
#else
  // No MPU configuration required for this MCU.
#endif
